...
function createCypherConsoles($)
{
  ...
  var RESOURCE_FILES = [ "javascripts/jquery-1.6.4.min.js", "javascripts/d3.min.js", "javascripts/visualization.js",
      "javascripts/console.js", "img/twitter.jpg", "img/info.png", "img/Link-icon.png", "img/graph.png" ];
  var iconSrc = 'css/utilities-terminal.png';
  if ( window.neo4jConsoleMediumIcon != undefined )
  {
    iconSrc = 'css/utilities-terminal-32.png';
  }
  var buttonStart = '<button class="cypherconsole" type="button"><img src="' + iconSrc + '" /> ';
  ...
  $( 'p.cypherconsole' ).each( function()
  {
    ...
    var button = $( buttonStart + title + buttonEnd );
